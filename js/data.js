...
const WordData = (function(){
  ...
  const ROOTS = [
    ...
    { key:"-oper-",  label:"-oper-",  meaning:"働く・作業する",     color:"#A9E34B" },
    { key:"-ord-",   label:"-ord-",   meaning:"順序・命令",         color:"#FFA94D" },
    { key:"-pac-",   label:"-pac-",   meaning:"平和・和解",         color:"#FF8787" },
    { key:"-pan-",   label:"-pan-",   meaning:"すべて・広がる",     color:"#B197FC" },
    { key:"-par-",   label:"-par-",   meaning:"準備・等しい",       color:"#63E6BE" },
    { key:"-patr-",  label:"-patr-",  meaning:"父・祖国",           color:"#FFD43B" },
    { key:"-pod-",   label:"-pod-",   meaning:"足",                 color:"#51CF66" },
    { key:"-pens-",  label:"-pens-",  meaning:"量る・支払う",       color:"#FF6B9D" },
    { key:"-pass-",  label:"-pass-",  meaning:"通る・歩く",         color:"#74C0FC" },
    { key:"-path-",  label:"-path-",  meaning:"感情・病・苦しみ",   color:"#C77DFF" },
    { key:"-pel-",   label:"-pel-",   meaning:"押す・追い払う",     color:"#69DB7C" },
    { key:"-pet-",   label:"-pet-",   meaning:"求める・急ぐ",       color:"#FF6B6B" },
    { key:"-plex-",  label:"-plex-",  meaning:"折り重なる・複雑な", color:"#CC5DE8" },
    { key:"-plic-",  label:"-plic-",  meaning:"折る・絡ませる",     color:"#339AF0" },
    { key:"-plor-",  label:"-plor-",  meaning:"叫ぶ・探索する",     color:"#F783AC" },
    { key:"-puls-",  label:"-puls-",  meaning:"押す・駆り立てる",   color:"#A9E34B" },
    { key:"-phor-",  label:"-phor-",  meaning:"運ぶ・伝える",       color:"#FFA94D" },
    { key:"-pon-",   label:"-pon-",   meaning:"置く・提示する",     color:"#FF8787" },
    { key:"-pos-",   label:"-pos-",   meaning:"置く・位置する",     color:"#B197FC" },
    { key:"-pound-", label:"-pound-", meaning:"置く・叩く",         color:"#63E6BE" },
    { key:"-prim-",  label:"-prim-",  meaning:"最初の・主要な",     color:"#FFD43B" },
    { key:"-prin-",  label:"-prin-",  meaning:"最初の・主要な",     color:"#51CF66" },
    { key:"-prob-",  label:"-prob-",  meaning:"試す・立証する",     color:"#FF6B9D" },
    { key:"-quer-",  label:"-quer-",  meaning:"探す・尋ねる",       color:"#74C0FC" },
    { key:"-quest-", label:"-quest-", meaning:"求める・探す",       color:"#C77DFF" },
    { key:"-quir-",  label:"-quir-",  meaning:"求める・調べる",     color:"#69DB7C" },
    { key:"-rect-",  label:"-rect-",  meaning:"まっすぐな・正す",   color:"#FF6B6B" },
    { key:"-reg-",   label:"-reg-",   meaning:"支配する・規則",     color:"#CC5DE8" },
    { key:"-roy-",   label:"-roy-",   meaning:"王の・王族",         color:"#339AF0" },
    { key:"-script-",label:"-script-",meaning:"書かれたもの",       color:"#F783AC" },
    { key:"-rid-",   label:"-rid-",   meaning:"笑う",               color:"#A9E34B" },
    { key:"-ris-",   label:"-ris-",   meaning:"笑う",               color:"#FFA94D" },
    { key:"-sacr-",  label:"-sacr-",  meaning:"神聖な・捧げる",     color:"#FF8787" },
    { key:"-sal-",   label:"-sal-",   meaning:"跳ぶ・飛び出す",     color:"#B197FC" },
    { key:"-sanct-", label:"-sanct-", meaning:"神聖な・承認する",   color:"#63E6BE" },
    { key:"-secut-", label:"-secut-", meaning:"続く・従う",         color:"#FFD43B" },
    { key:"-sequ-",  label:"-sequ-",  meaning:"続く・順序",         color:"#51CF66" },
    { key:"-simil-", label:"-simil-", meaning:"似た・同じ",         color:"#FF6B9D" },
    { key:"-simul-", label:"-simul-", meaning:"同時に・似せる",     color:"#74C0FC" },
    { key:"-sec-",   label:"-sec-",   meaning:"切る",               color:"#C77DFF" },
    { key:"-sens-",  label:"-sens-",  meaning:"感じる・知覚する",   color:"#69DB7C" },
    { key:"-serv-",  label:"-serv-",  meaning:"仕える・保つ",       color:"#FF6B6B" },
    { key:"-sist-",  label:"-sist-",  meaning:"立つ・止まる",       color:"#CC5DE8" },
    { key:"-spic-",  label:"-spic-",  meaning:"見る・観察する",     color:"#339AF0" },
  ];
